...
sudo apt install postgresql-9.6 postgresql-contrib-9.6 postgresql-9.6-postgis-scripts
...
sudo apt-get install php7.1 php7.1-pgsql libapache2-mod-php php7.1-common php7.1-gd php7.1-mysql php7.1-fpm php7.1-mcrypt php7.1-opcache php7.1-curl php7.1-cli php7.1-xml php7.1-sqlite3 sqlite3 php7.1-intl openssl php7.1-zip php7.1-mbstring php7.1-bz2 php7.1-xmlrpc php7.1-soap php7.1-bcmath php7.1-json php-pear
